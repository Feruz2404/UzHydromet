...
export function Hydrometeorology() {
  ...
  return (
    <section id="hydromet" className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div {...importanceMotion} className="mt-10 rounded-3xl bg-gradient-to-br from-brand-mist to-white border border-slate-100 p-6 lg:p-8 shadow-card">
        ...
        <div className="mt-12">
          ...
          <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {hydrometAreas.map((area) => {
              ...
              return (
                <motion.div key={area.id} {...cardMotion} className="rounded-2xl bg-white border border-slate-100 p-5 shadow-card hover:shadow-glow hover:border-brand-primary/30 transition-all">
