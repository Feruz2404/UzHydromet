    ...
    <footer className="relative bg-gradient-to-br from-brand-navy via-brand-deep to-brand-navy text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12 lg:py-14 grid md:grid-cols-12 gap-6 md:gap-10">
        ...
        <div className="md:col-span-3">
          <div className="text-[10px] sm:text-[11px] uppercase tracking-[0.16em] font-semibold text-white/60">{t('footer.quickLinks')}</div>
          <ul className="mt-3 sm:mt-4 space-y-2 sm:space-y-2.5 text-[13px] sm:text-sm text-white/80">
        ...
        <div className="md:col-span-5">
          <div className="text-[10px] sm:text-[11px] uppercase tracking-[0.16em] font-semibold text-white/60">{t('footer.contact')}</div>
      ...
      <div className="relative border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 text-[11px] sm:text-xs text-white/60 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
