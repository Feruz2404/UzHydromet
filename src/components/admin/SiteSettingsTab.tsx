  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white border border-slate-100 shadow-card p-5 sm:p-6 grid sm:grid-cols-2 gap-5">
        <ImageUpload label="Sayt logosi" kind="site-logo" value={draft.logoUrl} onChange={(url) => setField('logoUrl', url)} onClear={() => setField('logoUrl', '')} helperText="PNG, JPG, WEBP yoki SVG, <2MB. Yuklanish ekranida chiqadi. Header/footer'da esa doim rasmiy logo (public/logo.png) ko'rsatiladi." />
